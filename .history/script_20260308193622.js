...
function startLevel(level){
 ...
 hintsUsed = 0;
 document.getElementById("hintCount").innerText = maxHints;
...
// require player to attempt puzzle first
...
document.getElementById("hintCount").innerText = maxHints - hintsUsed;
break;
